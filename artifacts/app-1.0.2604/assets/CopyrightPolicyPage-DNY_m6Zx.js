import{n as s}from"./vendor-react-BEdvgpLm.js";import{i as l}from"./vendor-i18next-9bIyudl4.js";import{t as c}from"./MarkdownRenderer-TxoCOqYv.js";import{Y as d}from"./index-CIloXDVd.js";(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};e.SENTRY_RELEASE={id:"266a3d816bcfa4c371bb9a4aab547cb6d56f6bab"},e._sentryModuleMetadata=e._sentryModuleMetadata||{},e._sentryModuleMetadata[new e.Error().stack]=(function(o){for(var n=1;n<arguments.length;n++){var t=arguments[n];if(t!=null)for(var a in t)t.hasOwnProperty(a)&&(o[a]=t[a])}return o})({},e._sentryModuleMetadata[new e.Error().stack],{"_sentryBundlerPluginAppKey:pixai-web-app-key":!0});var r=new e.Error().stack;r&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[r]="2a742ed7-7bc1-463a-81eb-8ddb33ac4767",e._sentryDebugIdIdentifier="sentry-dbid-2a742ed7-7bc1-463a-81eb-8ddb33ac4767")}catch{}})();var h=`# **Copyright Policy**
...
1. We seriously take claims for infringement on copyright and/or related rights matters. We will respond to notices of alleged copyright infringement that comply with applicable laws, rules, regulations or practices etc. If user or you (such terms may be equally used) believe any materials accessible on or from PixAI infringe your copyright and/or related rights, you may request removal of those materials by submitting written notification, the “**Copyright** **Notice**” that must include substantially the following:
   ...
   **Copyright Notice Department**<br>
   Mewtant Inc.<br>
   Email: [copyright@withpixai.art](mailto:copyright@withpixai.art)
...
- By Email: [copyright@withpixai.art](mailto:copyright@withpixai.art)
...
`,i=s();function y(){const{t:e}=l(["common"]);return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(d,{content:e("common:meta.title.copyright")}),(0,i.jsx)(c,{className:"mx-auto prose dark:prose-invert",children:h})]})}export{y as Component};
